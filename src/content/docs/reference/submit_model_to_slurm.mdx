...
description: "This function submits a NONMEM model file to a SLURM cluster for execution, allowing for parallel processing and job queue management. The function handles job "
sidebar:
  label: "submit_model_to_slurm"
pagefind: true
---
