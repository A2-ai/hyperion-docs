...
description: "This function submits a NONMEM model file to a SGE cluster for execution, allowing for parallel processing and job queue management. The function handles job co"
sidebar:
  label: "submit_model_to_sge"
pagefind: true
---
...
<td>Whether to include DEBUG logs in output log file (default: FALSE)</td>
</tr>
</tbody>
</table>
</div>
