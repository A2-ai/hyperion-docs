...
description: "This function creates a metadata file that stores information about a NONMEM model, including its description, tags, and lineage information. The metadata is st"
sidebar:
  label: "set_metadata_file"
pagefind: true
---
...
<td>Path to the NONMEM model file, or a hyperion_nonmem_model object (required)</td>
</tr>
<tr>
...
<td>Optional model name/path this model was mechanically copied from</td>
</tr>
</tbody>
</table>
</div>
