...
description: "Calculates the CV% for Omega/Sigma diagonal parameters based on the specified transformation. For LogNormal and AddErr transforms, uses `sqrt(exp(estimate) - 1)"
pagefind: true
---
